...
`,P=null,j=null,T=null;async function ne(){return T||(T=(async()=>(P=await oe.chromium.launch({headless:!0}),j=await(await P.newContext()).newPage(),await j.addScriptTag({content:ke}),j))()),T}async function D(){P&&(await P.close(),P=null,j=null,T=null)}process.on("exit",()=>{P&&P.close()});async function se(){await D(),process.exit(0)}process.once("SIGTERM",se);process.once("SIGINT",se);async function M(t,e={}){let s=await(await ne()).evaluate(async([a,o])=>[...(await globalThis.parseCss(a,o)).entries()],[t,e]);return new Map(s)}async function A(t,e={}){let s=await(await ne()).evaluate(async([a,o])=>[...(await globalThis.parseSelectorOrder(a,o)).entries()],[t,e]);return new Map(s)}function V(t){let e=new Map;for(let[r,s]of t){e.has(r)||e.set(r,new Map);let a=e.get(r),o=new Map;for(let{selector:n,prop:c,value:l,important:p,layerRank:d}of s){let i=d??(p?1:0);a.has(n)||(a.set(n,new Map),o.set(n,new Map));let g=a.get(n),f=o.get(n),m=f.get(c);(m===void 0||i>=m)&&(g.set(c,{value:l,important:p}),f.set(c,i))}}return e}function Ee(t){let e=t.toLowerCase();return e.length===4?"#"+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]:e.length===5?"#"+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]+e[4]+e[4]:e}function z(t){let e=t.trim().replace(/\s+/g," ");return e=e.replace(/['"]/g,""),e=e.replace(/\s*,\s*/g,","),e=e.replace(/(^|[\s,(*\/+)\-])([+-]?)\.(\d)/g,(r,s,a,o)=>s==="-"?` - 0.${o}`:`${s}${a}0.${o}`),e=e.replace(/([%\)])-(\d)/g,"$1 - $2"),e=e.replace(/\s*([*/])\s*/g,"$1"),e=e.replace(/#[0-9a-fA-F]{3,8}\b/g,r=>Ee(r)),e}function N(t,e,r={}){let s=new Map,a=new Set([...t.keys(),...e.keys()]),o=["base",...[...a].filter(n=>n!=="base").sort()];for(let n of o){if(!a.has(n))continue;let c=t.get(n)||new Map,l=e.get(n)||new Map,p=new Set([...c.keys(),...l.keys()]),d=new Map,i=0;for(let f of[...p].sort()){let m=c.get(f)||new Map,y=l.get(f)||new Map,$=new Set([...m.keys(),...y.keys()]),w=new Map,u=0;for(let v of[...$].sort()){let S=m.get(v),h=y.get(v),k;!S&&h?(k={status:"added",newValue:h.value,newImportant:h.important},u++):S&&!h?(k={status:"removed",oldValue:S.value,oldImportant:S.important},u++):(r.ignoreCosmetic?z(S.value)!==z(h.value):S.value!==h.value)||S.important!==h.important?(k={status:"changed",oldValue:S.value,oldImportant:S.important,newValue:h.value,newImportant:h.important},u++):k={status:"unchanged",value:h.value,important:h.important},w.set(v,k)}let b;c.has(f)?l.has(f)?u>0?b="changed":b="unchanged":b="removed":b="added",d.set(f,{status:b,changeCount:u,props:w}),i+=u}let g;t.has(n)?e.has(n)?i>0?g="changed":g="unchanged":g="removed":g="added",s.set(n,{status:g,changeCount:i,selectors:d})}return s}function B([t,e,r],[s,a,o]){return t>s||t===s&&e>a||t===s&&e===a&&r>o}function H(t,e){return B(t,e)?1:B(e,t)?-1:0}function Re(t){let e=[],r=0,s=0,a=0,o=null;for(let c=0;c<t.length;c++){let l=t[c];o?l===o&&(o=null):l==='"'||l==="'"?o=l:l==="("?r++:l===")"?r>0&&r--:l==="["?s++:l==="]"?s>0&&s--:l===","&&r===0&&s===0&&(e.push(t.slice(a,c).trim()),a=c+1)}let n=t.slice(a).trim();return n&&e.push(n),e}function Oe(t,e){let r=1,s=0,a=e,o=null;for(;a<t.length&&r>0;){let n=t[a];o?n===o&&(o=null):n==='"'||n==="'"?o=n:n==="["?s++:n==="]"?s>0&&s--:s===0&&n==="("?r++:s===0&&n===")"&&r--,a++}return r===0?a:null}function re(t,e,r){let s=e.global||e.sticky?e:new RegExp(e.source,e.flags+"g");s.lastIndex=0;let a="",o=0,n;for(;(n=s.exec(t))!==null;){let c=n.index+n[0].length,l=Oe(t,c);if(a+=t.slice(o,n.index),l===null){a+=t.slice(c),o=t.length;break}r(t,c,l,n),o=l,s.lastIndex=o}return a+t.slice(o)}function I(t,e=0){if(e>100)return[0,0,0];let r=0,s=0,a=0,o=t.replace(/\\./g,"x"),n=l=>{let p=[0,0,0];for(let d of Re(l)){let i=I(d,e+1);B(i,p)&&(p=i)}r+=p[0],s+=p[1],a+=p[2]};o=re(o,/:(?<name>nth-child|nth-last-child|not|is|has|matches|where|host-context|host)\s*\(/gi,(l,p,d,i)=>{let g=i.groups.name.toLowerCase(),f=l.slice(p,d-1).trim();if(g==="nth-child"||g==="nth-last-child"){let m=f.match(/\sof\b/i);m&&n(f.slice(m.index+m[0].length).trim()),s++}else g==="where"||(n(f),(g==="host"||g==="host-context")&&s++)}),o=re(o,/::(?:slotted|cue)\s*\(/gi,(l,p,d)=>{n(l.slice(p,d-1).trim()),a++}),o=o.replace(/::[\w-]+(\([^)]*\))?/g,()=>(a++,"")),o=o.replace(/:(?:before|after|first-line|first-letter)(?![\w-])/gi,()=>(a++,"")),o=o.replace(/\[[^\]]*\]/g,()=>(s++,"")),o=o.replace(/:[^:\s>+~([\].#]+(\([^)]*\))?/g,()=>(s++,"")),o=o.replace(/#[\w-]+/g,()=>(r++,"")),o=o.replace(/\.[\w-]+/g,()=>(s++,"")),o=o.replace(/\|\|/g," ").replace(/[>+~]/g," "),o=o.replace(/(?:[\w-]+|\*)?\|/g,"");let c=o.split(/\s+/).filter(l=>l&&l!=="*"&&/^[a-zA-Z][\w-]*/.test(l));return a+=c.length,[r,s,a]}function q(t,e){let[r,s,a]=I(t),[o,n,c]=I(e);return r===o&&s===n&&a===c}function _e(t,e){let r=new Set(t),s=new Set(e),a=t.filter(d=>s.has(d)),o=e.filter(d=>r.has(d)),n=new Map;for(let d=0;d<a.length;d++)n.set(a[d],o[d]);let c=[],l=0,p=new Set;for(let d of t){if(!s.has(d)){c.push({type:"deleted",oldSelector:d,newSelector:null});continue}let i=n.get(d);for(;l<e.length&&!r.has(e[l]);)c.push({type:"added",oldSelector:null,newSelector:e[l]}),l++;if(d===i)c.push({type:"equal",oldSelector:d,newSelector:i});else{let g=[d,i].sort().join("\0");p.has(g)||(p.add(g),c.push({type:"moved",oldSelector:d,newSelector:i}))}l++}for(;l<e.length;)r.has(e[l])||c.push({type:"added",oldSelector:null,newSelector:e[l]}),l++;return c}function F(t,e,r,s,a,o,n){return!r&&!s?null:r?s?r.important!==s.important?r.important?t:e:a!==0?a>0?t:e:o>n?t:e:t:e}function U(t){let e="",r=0;for(let s of t){if(s==="("){r++;continue}if(s===")"){r--;continue}r===0&&(e+=s)}return e}function Me(t,e){let r=U(t),s=U(e);if(/[\s>+~]/.test(r)||/[\s>+~]/.test(s))return!0;function a(i){let g=U(i).replace(/:{1,2}[\w-]+/g,""),f=new Set,m=new Set,y=null;for(let w of g.matchAll(/#([\w-]+)/g))f.add(w[1]);for(let w of g.matchAll(/\.([\w-]+)/g))m.add(w[1]);let $=g.match(/^([a-zA-Z][\w-]*)/);return $&&(y=$[1]),{type:y,ids:f,classes:m}}let o=a(t),n=a(e);if(o.type&&n.type&&o.type!==n.type)return!1;let c=new Set([...o.ids,...o.classes]),l=new Set([...n.ids,...n.classes]);if(c.size===0||l.size===0)return!0;let p=[...c].every(i=>l.has(i)),d=[...l].every(i=>c.has(i));return p||d}function Pe(t,e,r,s,a){let o=t.oldSelector,n=t.newSelector;t.sameSpecificity=q(o,n),t.conflictingProps=[],t.hasOverlappingProps=!1;let c=e.indexOf(o),l=e.indexOf(n),p=r.indexOf(o),d=r.indexOf(n);if(c<0||l<0||p<0||d<0)return;let i=c<l,g=p<d;if(i===g||!Me(o,n))return;let f=H(I(o),I(n)),m=s.get(o)||new Map,y=s.get(n)||new Map,$=a.get(o)||new Map,w=a.get(n)||new Map;for(let[u,b]of $){let v=w.get(u);if(!v||(t.hasOverlappingProps=!0,b.value===v.value&&b.important===v.important))continue;let S=F(o,n,m.get(u),y.get(u),f,c,l),h=F(o,n,b,v,f,p,d);if(!h)continue;if(!S){let R=F(o,n,b,v,f,c,l);if(!R||R===h)continue;let _=a.get(R)?.get(u),O=a.get(h)?.get(u);if(!_||!O||_.value===O.value&&_.important===O.important)continue;t.conflictingProps.push({prop:u,oldEffective:null,newEffective:{value:O.value,important:O.important}});continue}let k=s.get(S)?.get(u),C=a.get(h)?.get(u);!k||!C||k.value===C.value&&k.important===C.important||t.conflictingProps.push({prop:u,oldEffective:{value:k.value,important:k.important},newEffective:{value:C.value,important:C.important}})}}async function X(t,e,r={},s=null,a={}){let o={semanticSelectors:r.semanticSelectors},n=s?.parseCss??M,c=s?.parseSelectorOrder??A,[l,p]=await Promise.all([c(t,o),c(e,o)]),[d,i]=await Promise.all([a.parsedOld??n(t,o),a.parsedNew??n(e,o)]),g=V(d),f=V(i),m=new Set([...l.keys(),...p.keys()]),y=["base",...[...m].filter(w=>w!=="base").sort()],$=[];for(let w of y){if(!m.has(w))continue;let u=l.get(w)||[],b=p.get(w)||[],v=_e(u,b),S=g.get(w)||new Map,h=f.get(w)||new Map;for(let C of v)C.type==="moved"&&Pe(C,u,b,S,h);let k=v.some(C=>C.type==="moved"&&C.conflictingProps?.length>0);v.some(C=>C.type!=="equal")&&$.push({contextKey:w,rows:v,hasWarning:k})}return $}var Ve=new Map([["padding",["padding-top","padding-right","padding-bottom","padding-left","padding-inline-start","padding-inline-end","padding-block-start","padding-block-end","padding-inline","padding-block"]],["margin",["margin-top","margin-right","margin-bottom","margin-left","margin-inline-start","margin-inline-end","margin-block-start","margin-block-end","margin-inline","margin-block"]],["border",["border-top","border-right","border-bottom","border-left","border-width","border-style","border-color","border-top-width","border-top-style","border-top-color","border-right-width","border-right-style","border-right-color","border-bottom-width","border-bottom-style","border-bottom-color","border-left-width","border-left-style","border-left-color"]],["border-top",["border-top-width","border-top-style","border-top-color"]],["border-right",["border-right-width","border-right-style","border-right-color"]],["border-bottom",["border-bottom-width","border-bottom-style","border-bottom-color"]],["border-left",["border-left-width","border-left-style","border-left-color"]],["border-width",["border-top-width","border-right-width","border-bottom-width","border-left-width"]],["border-style",["border-top-style","border-right-style","border-bottom-style","border-left-style"]],["border-color",["border-top-color","border-right-color","border-bottom-color","border-left-color"]],["border-radius",["border-top-left-radius","border-top-right-radius","border-bottom-right-radius","border-bottom-left-radius"]],["border-inline",["border-inline-start","border-inline-end","border-inline-width","border-inline-style","border-inline-color"]],["border-block",["border-block-start","border-block-end","border-block-width","border-block-style","border-block-color"]],["background",["background-color","background-image","background-position","background-size","background-repeat","background-attachment","background-origin","background-clip"]],["font",["font-style","font-variant","font-weight","font-stretch","font-size","font-family","line-height"]],["flex",["flex-grow","flex-shrink","flex-basis"]],["flex-flow",["flex-direction","flex-wrap"]],["grid-column",["grid-column-start","grid-column-end"]],["grid-row",["grid-row-start","grid-row-end"]],["grid-template",["grid-template-rows","grid-template-columns","grid-template-areas"]],["transition",["transition-property","transition-duration","transition-timing-function","transition-delay"]],["animation",["animation-name","animation-duration","animation-timing-function","animation-delay","animation-iteration-count","animation-direction","animation-fill-mode","animation-play-state"]],["inset",["top","right","bottom","left"]],["inset-inline",["inset-inline-start","inset-inline-end"]],["inset-block",["inset-block-start","inset-block-end"]],["padding-inline",["padding-inline-start","padding-inline-end"]],["padding-block",["padding-block-start","padding-block-end"]],["margin-inline",["margin-inline-start","margin-inline-end"]],["margin-block",["margin-block-start","margin-block-end"]],["overflow",["overflow-x","overflow-y"]],["text-decoration",["text-decoration-line","text-decoration-style","text-decoration-color","text-decoration-thickness"]],["outline",["outline-width","outline-style","outline-color"]],["list-style",["list-style-type","list-style-position","list-style-image"]],["gap",["row-gap","column-gap"]],["place-items",["align-items","justify-items"]],["place-content",["align-content","justify-content"]],["place-self",["align-self","justify-self"]],["mask",["mask-image","mask-position","mask-size","mask-repeat","mask-origin","mask-clip","mask-mode","mask-composite"]],["scroll-margin",["scroll-margin-top","scroll-margin-right","scroll-margin-bottom","scroll-margin-left"]],["scroll-padding",["scroll-padding-top","scroll-padding-right","scroll-padding-bottom","scroll-padding-left"]]]);function ae(t){let e=new Map;for(let r=0;r<t.length;r++){let s=t[r];e.has(s.selector)||e.set(s.selector,[]),e.get(s.selector).push({...s,idx:r})}return e}function le(t,e,r){let s=null,a=null;for(let o of t)o.prop===e?(!s||o.layerRank>s.layerRank||o.layerRank===s.layerRank&&o.idx>s.idx)&&(s=o):o.prop===r&&(!a||o.layerRank>a.layerRank||o.layerRank===a.layerRank&&o.idx>a.idx)&&(a=o);return!s&&!a?null:s?a?s.layerRank!==a.layerRank?s.layerRank>a.layerRank?"shorthand":"longhand":s.idx>a.idx?"shorthand":"longhand":"shorthand":"longhand"}function K(t,e){return t.reduce((r,s)=>s.prop!==e?r:!r||s.layerRank>r.layerRank||s.layerRank===r.layerRank&&s.idx>r.idx?s:r,null)}async function G(t,e,r={},s=null){let a={semanticSelectors:r.semanticSelectors},o=s?.parseCss??M,n=typeof t=="string"?await o(t,a):t,c=typeof e=="string"?await o(e,a):e,l=new Set([...n.keys(),...c.keys()]),p=["base",...[...l].filter(f=>f!=="base").sort()],d=[],i=!1;for(let f of p){if(!l.has(f))continue;let m=n.get(f)??[],y=c.get(f)??[],$=ae(m),w=ae(y);for(let[u,b]of w){let v=$.get(u)??[],S=[],h=new Map;for(let[k,C]of Ve){let R=K(b,k);if(R)for(let _ of C){if(!b.some(W=>W.prop===_))continue;let O=h.get(_);(!O||R.layerRank>O.bestShorthandDecl.layerRank||R.layerRank===O.bestShorthandDecl.layerRank&&R.idx>O.bestShorthandDecl.idx)&&h.set(_,{shorthand:k,bestShorthandDecl:R})}}for(let[k,{shorthand:C,bestShorthandDecl:R}]of h){let _=le(v,C,k),O=le(b,C,k);if(_===O)continue;let W=O==="shorthand"?"A":"B";W==="A"&&(i=!0);let J=K(v,C),Z=K(b,k),Q=K(v,k);S.push({shorthand:C,longhand:k,oldWinner:_,newWinner:O,direction:W,oldShorthandValue:J?.value??null,oldLonghandValue:Q?.value??null,longhandValue:Z?.value??null,shorthandValue:R?.value??null,oldShorthandImportant:J?.important??!1,oldLonghandImportant:Q?.important??!1,shorthandImportant:R?.important??!1,longhandImportant:Z?.important??!1})}S.length>0&&d.push({contextKey:f,selector:u,conflicts:S})}}let g=new Map;for(let f of d)g.has(f.contextKey)||g.set(f.contextKey,{contextKey:f.contextKey,selectors:[]}),g.get(f.contextKey).selectors.push({selector:f.selector,conflicts:f.conflicts});return{hasWarning:i,risks:[...g.values()]}}var Ie=new Map([["padding",["padding-top","padding-right","padding-bottom","padding-left"]],["margin",["margin-top","margin-right","margin-bottom","margin-left"]],["inset",["top","right","bottom","left"]],["border-width",["border-top-width","border-right-width","border-bottom-width","border-left-width"]],["border-style",["border-top-style","border-right-style","border-bottom-style","border-left-style"]],["border-color",["border-top-color","border-right-color","border-bottom-color","border-left-color"]],["border-radius",["border-top-left-radius","border-top-right-radius","border-bottom-right-radius","border-bottom-left-radius"]],["scroll-margin",["scroll-margin-top","scroll-margin-right","scroll-margin-bottom","scroll-margin-left"]],["scroll-padding",["scroll-padding-top","scroll-padding-right","scroll-padding-bottom","scroll-padding-left"]]]),De=new Map([["overflow",["overflow-x","overflow-y"]],["gap",["row-gap","column-gap"]],["place-items",["align-items","justify-items"]],["place-content",["align-content","justify-content"]],["place-self",["align-self","justify-self"]],["padding-inline",["padding-inline-start","padding-inline-end"]],["padding-block",["padding-block-start","padding-block-end"]],["margin-inline",["margin-inline-start","margin-inline-end"]],["margin-block",["margin-block-start","margin-block-end"]],["inset-inline",["inset-inline-start","inset-inline-end"]],["inset-block",["inset-block-start","inset-block-end"]]]),Ae=new Set(["border","border-top","border-right","border-bottom","border-left","border-inline-start","border-inline-end","border-block-start","border-block-end","outline"]),Le=new Set(["none","hidden","dotted","dashed","solid","double","groove","ridge","inset","outset"]),We=new Set(["row","row-reverse","column","column-reverse"]),je=new Set(["nowrap","wrap","wrap-reverse"]);function L(t){let e=[],r=0,s=null,a=0,o=t.trim();for(let c=0;c<o.length;c++){let l=o[c];if(s)l===s&&(s=null);else if(l==='"'||l==="'")s=l;else if(l==="(")r++;else if(l===")")r>0&&r--;else if(/\s/.test(l)&&r===0){let p=o.slice(a,c);p&&e.push(p),a=c+1}}let n=o.slice(a);return n&&e.push(n),e}function ce(t,e,r){let s=Ie.get(t);if(s){let o=s.indexOf(e);if(o!==-1){let n=L(r);return(n.length===1?[n[0],n[0],n[0],n[0]]:n.length===2?[n[0],n[1],n[0],n[1]]:n.length===3?[n[0],n[1],n[2],n[1]]:[n[0],n[1],n[2],n[3]])[o]}}let a=De.get(t);if(a){let o=a.indexOf(e);if(o!==-1){let n=L(r);return n.length===1?n[0]:n[o]??n[0]}}if(Ae.has(t)){let o=L(r),n="medium",c="none",l="currentcolor";for(let p of o){let d=p.toLowerCase();Le.has(d)?c=p:/^(thin|medium|thick)$/i.test(p)||/^[0-9]/.test(p)||/^(calc|var|env|min|max|clamp)\(/i.test(p)?n=p:l=p}if(e.endsWith("-width"))return n;if(e.endsWith("-style"))return c;if(e.endsWith("-color"))return l}if(t==="flex"){let o=L(r),n=o[0]?.toLowerCase();if(n==="none"){if(e==="flex-grow"||e==="flex-shrink")return"0";if(e==="flex-basis")return"auto"}else if(n==="auto"){if(e==="flex-grow"||e==="flex-shrink")return"1";if(e==="flex-basis")return"auto"}else if(o.length===3){if(e==="flex-grow")return o[0];if(e==="flex-shrink")return o[1];if(e==="flex-basis")return o[2]}}if(t==="flex-flow")for(let o of L(r)){let n=o.toLowerCase();if(We.has(n)&&e==="flex-direction"||je.has(n)&&e==="flex-wrap")return o}return r}function Y(t,e){if(e?.risks?.length)for(let{contextKey:r,selectors:s}of e.risks){let a=t.get(r);if(a)for(let{selector:o,conflicts:n}of s){let c=a.selectors.get(o);if(!c)continue;let l=0;for(let{shorthand:p,longhand:d,oldWinner:i,newWinner:g,longhandValue:f,shorthandValue:m,oldShorthandValue:y,oldLonghandValue:$,oldShorthandImportant:w,oldLonghandImportant:u,shorthandImportant:b,longhandImportant:v}of n){let S=c.props.get(d);if(S&&S.status!=="unchanged")continue;let h=g==="longhand"?f:ce(p,d,m??""),k=g==="longhand"?v:b;if(i===null)c.props.set(d,{status:"added",newValue:h,newImportant:k});else{let C=i==="longhand"?$:ce(p,d,y??""),R=i==="longhand"?u:w;c.props.set(d,{status:"changed",oldValue:C,oldImportant:R,newValue:h,newImportant:k})}l++}l>0&&(c.changeCount+=l,c.status!=="added"&&c.status!=="removed"&&(c.status="changed"),a.changeCount+=l,a.status!=="added"&&a.status!=="removed"&&(a.status="changed"))}}}var ue=require("node:fs"),ge=require("node:url");function x(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function ie(t,e){let{status:r}=e;function s(a){return a?' <span class="important">!important</span>':""}return r==="added"?`
    ...
    </div>`}function Te(t,e){let{props:r}=e,s=[],a=[];for(let[n,c]of r){let l=x(n);if(c.status==="unchanged"){let p=x(c.value)+(c.important?" !important":"");s.push(`<div class="detail-line detail-line--unchanged"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${p}</span>;</div>`),a.push(`<div class="detail-line detail-line--unchanged"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${p}</span>;</div>`)}else if(c.status==="added"){s.push('<div class="detail-line detail-line--empty"></div>');let p=x(c.newValue)+(c.newImportant?" !important":"");a.push(`<div class="detail-line detail-line--added"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${p}</span>;</div>`)}else if(c.status==="removed"){let p=x(c.oldValue)+(c.oldImportant?" !important":"");s.push(`<div class="detail-line detail-line--removed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${p}</span>;</div>`),a.push('<div class="detail-line detail-line--empty"></div>')}else{let p=x(c.oldValue)+(c.oldImportant?" !important":""),d=x(c.newValue)+(c.newImportant?" !important":"");s.push(`<div class="detail-line detail-line--changed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${p}</span>;</div>`),a.push(`<div class="detail-line detail-line--changed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${d}</span>;</div>`)}}let o=x(t);return`
...
`)}}</code></pre>
    ...
    </div>`}function ze(t,e,{highlightHtml:r,showUnchanged:s=!1,contextKey:a="",expanded:o=!1}={}){let{status:n,changeCount:c,props:l}=e,p=r||x(t),d={added:"badge--added",removed:"badge--removed",changed:"badge--changed",unchanged:"badge--unchanged"}[n],i={added:`+${[...l.values()].filter(u=>u.status==="added").length} \u8FFD\u52A0`,removed:`\u2212${[...l.values()].filter(u=>u.status==="removed").length} \u524A\u9664`,changed:(()=>{let u=[...l.values()].filter(h=>h.status==="added").length,b=[...l.values()].filter(h=>h.status==="removed").length,v=[...l.values()].filter(h=>h.status==="changed").length,S=[];return u&&S.push(`+${u}`),b&&S.push(`\u2212${b}`),v&&S.push(`~${v}`),S.join(" ")})(),unchanged:"\u5909\u66F4\u306A\u3057"}[n],g=[...l.entries()].filter(([,u])=>u.status!=="unchanged"),f=[...l.entries()].filter(([,u])=>u.status==="unchanged"),m=[...g.map(([u,b])=>ie(u,b)),...s?f.map(([u,b])=>ie(u,b)):[]].join(""),y=f.length>0&&!s?`<button class="unchanged-toggle" data-selector="${x(t)}">
           \u5909\u66F4\u306A\u3057 ${f.length} \u4EF6\u3092\u8868\u793A
    ...
    <div class="selector-card selector-card--${n}" data-selector="${x(t)}" data-context="${x(a)}"${w}>
      <div class="selector-header" role="button" tabindex="0" title="\u30AF\u30EA\u30C3\u30AF\u3067\u65B0\u65E7\u306E\u5168\u30D7\u30ED\u30D1\u30C6\u30A3\u3092\u8868\u793A">
        ...
        <span class="selector-badge ${d}">${i}</span>
    ...
    </tr>`:""}function Fe(t,e=!1){let{contextKey:r,rows:s,hasWarning:a}=t,o=r==="base"?"\u30C8\u30C3\u30D7\u30EC\u30D9\u30EB (base)":x(r),n=s.filter(d=>d.type==="moved").length,c=n===0?'<span class="or-ctx-badge or-ctx-badge--ok">\u9806\u5E8F\u5909\u66F4\u306A\u3057</span>':a?`<span class="or-ctx-badge or-ctx-badge--warning">${n} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4</span>`:`<span class="or-ctx-badge or-ctx-badge--moved">${n} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4\uFF08\u30EA\u30B9\u30AF\u306A\u3057\uFF09</span>`,l=`<span class="or-toggle-icon">${e?"\u25BC":"\u25B6"}</span>`,p=s.map(d=>d.type==="moved"?He(d):qe(d)).join("");return`<div class="or-context">
  ...
  </div>`}function de(t,{activeContext:e="all",filterOrderRisk:r=!1,expandedContexts:s=new Set}={}){if(!t||t.length===0)return"";let a=r?t.filter(p=>p.hasWarning):t,o=e==="all"?a:a.filter(p=>p.contextKey===e);if(o.length===0)return"";let n=o.reduce((p,d)=>p+d.rows.filter(i=>i.type==="moved").length,0);if(n===0)return"";let c=o.some(p=>p.hasWarning),l=o.map(p=>Fe(p,s.has(p.contextKey))).join("");return`<section class="order-risks-section">
    <div class="order-risks-header">
      <span class="order-risks-title">\u30BB\u30EC\u30AF\u30BF\u51FA\u73FE\u9806\u306E\u6BD4\u8F03</span>
      ${c?`<span class="order-risks-count order-risks-count--warning">\u26A0\uFE0F ${n} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4</span>`:`<span class="order-risks-count order-risks-count--ok">${n} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4\uFF08\u30EA\u30B9\u30AF\u306A\u3057\uFF09</span>`}
    </div>
    ${l}
  </section>`}function pe(t){if(!t||!t.risks||t.risks.length===0)return"";let{risks:e,hasWarning:r}=t,s=e.reduce((o,n)=>o+n.selectors.reduce((c,l)=>c+l.conflicts.length,0),0);if(s===0)return"";let a=e.map(({contextKey:o,selectors:n})=>{let c=o==="base"?"\u30C8\u30C3\u30D7\u30EC\u30D9\u30EB (base)":x(o),l=n.some(i=>i.conflicts.some(g=>g.direction==="A")),p=n.map(({selector:i,conflicts:g})=>{let f=g.map(({shorthand:m,longhand:y,direction:$,oldWinner:w,longhandValue:u,shorthandValue:b,oldShorthandValue:v})=>{let S=x(m),h=x(y),k=x(b??""),C=x(v??""),R=x(u??"");return $==="A"?`<div class="sr-conflict sr-conflict--risk">
        ...
        <code class="sr-selector-name">${x(i)}</code>
    ...
    ${a}
  </section>`}function fe(t,e,{activeContext:r="all",showUnchanged:s=!1,expandedSelectors:a=new Set}={}){if(!t||t.size===0)return'<div class="empty-state">CSS \u3092\u8AAD\u307F\u8FBC\u3093\u3067\u304F\u3060\u3055\u3044\u3002</div>';let o=null;if(e!==null){o=new Map;for(let c of e)o.has(c.contextKey)||o.set(c.contextKey,[]),o.get(c.contextKey).push({selector:c.selector,positions:c.positions||new Set})}let n="";for(let[c,l]of t){if(r!=="all"&&c!==r)continue;let p=o?o.get(c)||[]:null;o&&p.length===0||(n+=Ke(c,l,p,{showUnchanged:s,expandedSelectors:a}))}return n||'<div class="empty-state">\u6761\u4EF6\u306B\u4E00\u81F4\u3059\u308B\u30BB\u30EC\u30AF\u30BF\u304C\u3042\u308A\u307E\u305B\u3093\u3002</div>'}var Ye={};function Ue(){return`/* \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
   CSS Diff App \u2014 \u30B9\u30BF\u30A4\u30EB
   \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
...
`;function he(t,e,r){let s=Ue(),a=[],o=new Set;for(let[i,g]of t)for(let[f,m]of g.selectors)m.status!=="unchanged"&&(a.push({contextKey:i,selector:f,positions:new Set}),o.add(`${i}||${f}`));let n=a.length>0,c=e&&e.length>0,l=r&&r.risks&&r.risks.length>0,p=e?new Set(e.map(i=>i.contextKey)):new Set,d="";return n&&(d+=`<div class="diff-section">${fe(t,a,{expandedSelectors:o})}</div>`),c&&(d+=de(e,{expandedContexts:p})),l&&(d+=pe(r)),!n&&!c&&!l&&(d='<div class="empty-state">\u5DEE\u5206\u306F\u3042\u308A\u307E\u305B\u3093\u3002</div>'),`<!DOCTYPE html>
<html lang="ja">
<head>
  <meta charset="UTF-8">
...
`),console.error(xe),process.exit(2));var Je=new Set(["text","json","html"]);Je.has(E.format)||(console.error("Error: --format \u306F text | json | html \u306E\u3044\u305A\u308C\u304B\u3067\u3059"),process.exit(2));var Ze=new Set(["changed","added","removed","unchanged","all"]);Ze.has(E.filter)||(console.error("Error: --filter \u306F changed | added | removed | unchanged | all \u306E\u3044\u305A\u308C\u304B\u3067\u3059"),process.exit(2));function Se(t){try{return(0,we.readFileSync)(t,"utf8")}catch(e){console.error(`Error: \u30D5\u30A1\u30A4\u30EB\u3092\u8AAD\u307F\u8FBC\u3081\u307E\u305B\u3093 "${t}": ${e.message}`),process.exit(2)}}var[Qe,et]=$e,me=Se(Qe),be=Se(et);async function tt(){let t,e=[],r={hasWarning:!1,risks:[]};try{let d={semanticSelectors:E["semantic-selectors"]},[i,g]=await Promise.all([M(me,d),M(be,d)]);t=N(V(i),V(g),{ignoreCosmetic:E["ignore-cosmetic"]}),E["order-risk"]&&(e=await X(me,be,{semanticSelectors:E["semantic-selectors"]},{parseCss:M,parseSelectorOrder:A})),E["shorthand-risk"]&&(r=await G(i,g,{semanticSelectors:E["semantic-selectors"]}),Y(t,r))}catch(d){await D().catch(()=>{}),console.error(`Parse error: ${d.message}`),process.exit(2)}function s(d,i){return i==="all"?!0:i==="changed"?d!=="unchanged":d===i}function a(d){let i=0,g=0,f=0,m=0;for(let[,y]of d)for(let[,$]of y.selectors)for(let[,w]of $.props)w.status==="changed"?i++:w.status==="added"?g++:w.status==="removed"?f++:m++;return{changed:i,added:g,removed:f,unchanged:m}}let o=a(t),n=o.changed>0||o.added>0||o.removed>0,c=E["order-risk"]&&e.some(d=>d.hasWarning),l=E["shorthand-risk"]&&r.hasWarning,p=E.filter;if(E.format==="html"){let d=he(t,E["order-risk"]?e:null,E["shorthand-risk"]?r:null);process.stdout.write(d),await D(),process.exit(n||c||l?1:0)}if(E.format==="json"){let d=[];for(let[g,f]of t){let m=[];for(let[y,$]of f.selectors){let w=[];for(let[u,b]of $.props)s(b.status,p)&&w.push({prop:u,...b});w.length>0&&m.push({selector:y,status:$.status,changeCount:$.changeCount,props:w})}m.length>0&&d.push({key:g,status:f.status,changeCount:f.changeCount,selectors:m})}let i={version:1,summary:o,contexts:d};E["order-risk"]&&(i.orderRisks=e),E["shorthand-risk"]&&(i.shorthandRisks=r),console.log(JSON.stringify(i,null,2))}else{let d=!E["no-color"]&&!!process.stdout.isTTY,i={reset:d?"\x1B[0m":"",yellow:d?"\x1B[33m":"",green:d?"\x1B[32m":"",red:d?"\x1B[31m":"",cyan:d?"\x1B[36m":"",dim:d?"\x1B[2m":""};for(let[f,m]of t){let y=[];for(let[$,w]of m.selectors){let u=[];for(let[b,v]of w.props)s(v.status,p)&&(v.status==="changed"?u.push(`    ${i.yellow}~${i.reset} ${b}: ${v.oldValue} \u2192 ${v.newValue}`):v.status==="added"?u.push(`    ${i.green}+${i.reset} ${b}: ${v.newValue}`):v.status==="removed"?u.push(`    ${i.red}-${i.reset} ${b}: ${v.oldValue}`):u.push(`      ${b}: ${v.value}`));u.length>0&&(y.push(`  ${i.dim}${$}${i.reset}`),y.push(...u))}y.length>0&&(console.log(`
${i.cyan}[${f}]${i.reset}`),y.forEach($=>console.log($)))}let g=[];if(o.changed&&g.push(`${i.yellow}${o.changed} changed${i.reset}`),o.added&&g.push(`${i.green}${o.added} added${i.reset}`),o.removed&&g.push(`${i.red}${o.removed} removed${i.reset}`),(p==="all"||p==="unchanged")&&o.unchanged&&g.push(`${o.unchanged} unchanged`),console.log(`
...
${i.cyan}[${f}]${i.reset}`),console.log(`  ${"\u65E7 CSS".padEnd($)}  ${"\u65B0 CSS".padEnd(w)}  \u72B6\u614B`),console.log(`  ${"-".repeat($)}  ${"-".repeat(w)}  ------`);for(let u of y){let b=(u.oldSelector??"-").padEnd($),v=(u.newSelector??"-").padEnd(w);if(u.type==="moved"){let S=u.sameSpecificity?` ${i.dim}(\u8A73\u7D30\u5EA6\u304C\u540C\u3058)${i.reset}`:"";if(console.log(`  ${b}  ${v}  ${i.yellow}\u26A0 \u9806\u5E8F\u5909\u66F4${i.reset}${S}`),u.conflictingProps&&u.conflictingProps.length>0)for(let h of u.conflictingProps){let k=_=>_?.important?" !important":"",C=h.oldEffective?`${h.oldEffective.value}${k(h.oldEffective)}`:"\u65E7 CSS \u672A\u5BA3\u8A00",R=h.newEffective?`${h.newEffective.value}${k(h.newEffective)}`:"\u65B0 CSS \u672A\u5BA3\u8A00";console.log(`    ${i.dim}${h.prop}: ${C} \u2192 ${R}${i.reset}`)}}else u.type==="deleted"?console.log(`  ${b}  ${"-".padEnd(w)}  ${i.red}- \u524A\u9664${i.reset}`):u.type==="added"&&console.log(`  ${"-".padEnd($)}  ${v}  ${i.green}+ \u8FFD\u52A0${i.reset}`)}}}if(E["shorthand-risk"]&&r.risks.length>0){console.log(`
Shorthand Risks:`);for(let{contextKey:f,selectors:m}of r.risks){console.log(`
${i.cyan}[${f}]${i.reset}`);for(let{selector:y,conflicts:$}of m){console.log(`  ${i.dim}${y}${i.reset}`);for(let w of $){let{shorthand:u,longhand:b,direction:v,oldWinner:S,longhandValue:h,shorthandValue:k,oldLonghandValue:C,oldShorthandValue:R}=w;console.log(v==="A"?`    ${i.yellow}\u26A0 ${b}: shorthand \u306B\u4E0A\u66F8\u304D\u3055\u308C\u305F\uFF08\u65E7: ${b}:${C??""} \u304C\u6709\u52B9 \u2192 \u65B0: ${u}:${k??""} \u306B\u4E0A\u66F8\u304D\uFF09${i.reset}`:S===null?`    ${i.green}\u2197 ${b}: \u65B0\u898F\uFF08longhand \u304C\u6709\u52B9: ${b}:${h??""}\uFF09${i.reset}`:`    ${i.green}\u2197 ${b}: shorthand \u4E0A\u66F8\u304D\u89E3\u6D88\uFF08\u65E7: ${u}:${R??""} \u306B\u4E0A\u66F8\u304D \u2192 \u65B0: ${b}:${h??""} \u304C\u6709\u52B9\uFF09${i.reset}`)}}}}}await D(),process.exit(n||c||l?1:0)}tt().catch(async t=>{console.error(t.message||String(t));try{await D()}catch{}process.exit(1)});
