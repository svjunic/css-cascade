...
https://www.w3ctech.com/topic/2226`));let a=t(...o);return a.postcssPlugin=e,a.postcssVersion=new Vt().version,a}let i;return Object.defineProperty(n,"postcss",{get(){return i||(i=n()),i}}),n.process=function(o,a,l){return O([n(l)]).process(o,a)},n};O.stringify=Lo;O.parse=Ao;O.fromJSON=bo;O.list=Eo;O.comment=s=>new Kn(s);O.atRule=s=>new Wn(s);O.decl=s=>new Hn(s);O.rule=s=>new Yn(s);O.root=s=>new Jn(s);O.document=s=>new Qn(s);O.CssSyntaxError=So;O.Declaration=Hn;O.Container=xo;O.Processor=Vt;O.Document=Qn;O.Comment=Kn;O.Warning=Ro;O.AtRule=Wn;O.Result=Mo;O.Input=Co;O.Rule=Yn;O.Root=Jn;O.Node=Oo;_o.registerPostcss(O);Xn.exports=O;O.default=O});var ms=require("node:fs"),gs=require("node:util");var M=Ls(Zn(),1),Wt=M.default,Gl=M.default.stringify,Vl=M.default.fromJSON,Wl=M.default.plugin,Kl=M.default.parse,Hl=M.default.list,Ql=M.default.document,Jl=M.default.comment,Yl=M.default.atRule,Xl=M.default.rule,Zl=M.default.decl,ea=M.default.root,ta=M.default.CssSyntaxError,ra=M.default.Declaration,na=M.default.Container,sa=M.default.Processor,ia=M.default.Document,oa=M.default.Comment,la=M.default.Warning,aa=M.default.AtRule,ua=M.default.Result,ca=M.default.Input,fa=M.default.Rule,ha=M.default.Root,pa=M.default.Node;function it(s){return s.trim().replace(/\s+/g," ").replace(/\s*([>+~])\s*/g," $1 ").trim()}function Kt(s){let e=[],t=s.replace(/url\((?:[^)"'\\]|"(?:[^"\\]|\\.)*"|'(?:[^'\\]|\\.)*')*\)/gi,o=>(e.push(o),"\0"+(e.length-1)+"\0")),r="",n=0;for(;n<t.length;){if(t[n]!=="s"&&t[n]!=="S"){r+=t[n++];continue}let o=t.slice(n).match(/^selector\s*\(/i);if(o){let a=1,l=n+o[0].length,c=null,u=0;for(;l<t.length&&a>0;){let p=t[l];c?p===c&&(c=null):p==='"'||p==="'"?c=p:p==="["?u++:p==="]"?u>0&&u--:u===0&&p==="("?a++:u===0&&p===")"&&a--,l++}e.push(t.slice(n,l)),r+="\0"+(e.length-1)+"\0",n=l}else r+=t[n++]}return t=r,t.trim().replace(/\s*:\s*/g,": ").replace(/\s+/g," ").replace(/\b(not|only)\s*\(/gi,"$1 (").replace(/\)\s*(and|or|not|only)\s*\(/gi,") $1 (").trim().replace(/\s+/g," ").replace(/\x00(\d+)\x00/g,(o,a)=>e[+a])}function Ht(s){return s.trim()}function $o(s){let e=s.toLowerCase();return e.length===4?"#"+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]:e.length===5?"#"+e[1]+e[1]+e[2]+e[2]+e[3]+e[3]+e[4]+e[4]:e}function Qt(s){let e=s.trim().replace(/\s+/g," ");return e=e.replace(/['"]/g,""),e=e.replace(/\s*,\s*/g,","),e=e.replace(/(^|[\s,(*\/+)\-])([+-]?)\.(\d)/g,(t,r,n,i)=>r==="-"?` - 0.${i}`:`${r}${n}0.${i}`),e=e.replace(/([%\)])-(\d)/g,"$1 - $2"),e=e.replace(/\s*([*/])\s*/g,"$1"),e=e.replace(/#[0-9a-fA-F]{3,8}\b/g,t=>$o(t)),e}function Jt(s){let e=it(s);return e=e.replace(/\[([^\]]*)\]/g,(t,r)=>{let n=r.replace(/\s*([~|^$*]?)\s*=\s*/g,"$1=");return n=n.replace(/(['"])(.*?)\1/g,"$2"),"["+n.trim()+"]"}),e}function Po(s){let e={};for(let i of s){let o=i.prop.toLowerCase();(o==="font-family"||o==="font-weight"||o==="font-style")&&(e[o]=Ht(i.value).replace(/['"]/g,""))}let t=(e["font-family"]||"unknown").toLowerCase(),r=(e["font-weight"]||"normal").toLowerCase(),n=(e["font-style"]||"normal").toLowerCase();return`${t}/${r}/${n}`}function Io(s,e){return`@keyframes ${e.trim()}`}var Yt=new Set(["media","supports","container"]);function es(s,e,t){if(!t)return s;let r=new Map;for(let[i,o]of s)r.set(i,o.slice());let n=r.get(e);return n?n.push(t):r.set(e,[t]),r}function qe(s){let e=[];for(let t of Yt){let r=s.get(t);r&&r.length&&e.push(`@${t} ${r.join(" and ")}`)}return e.length?e.join(" and "):"base"}function No(s,e,t,r){let n=s==null?null:t.get(s)??null,i=n!=null;return e?r+1+(i?r-n:0):i?n:r}function Xt(s,e={}){let t=new Map,r=0;function n(f){return t.has(f)||t.set(f,new Map),t.get(f)}function i(f,h){n(f).set(h,r++)}let o=e.semanticSelectors?Jt:it;function a(f,h){for(let d of f.selectors.map(v=>o(v)))i(h,d)}function l(f,h){let d=f.name.toLowerCase();if(Yt.has(d)){let v=es(h,d,Kt(f.params)),g=qe(v);f.each(y=>{y.type==="rule"?a(y,g):y.type==="atrule"&&l(y,v)})}else if(!(d==="font-face"||d==="keyframes"||d==="-webkit-keyframes"||d==="charset"||d==="import"||d==="namespace")){if(f.nodes){let v=qe(h);f.each(g=>{g.type==="rule"?a(g,v):g.type==="atrule"&&l(g,h)})}}}let c=Wt.parse(s,{from:void 0}),u=new Map;c.each(f=>{f.type==="rule"?a(f,"base"):f.type==="atrule"&&l(f,u)});let p=new Map;for(let[f,h]of t)p.set(f,[...h.entries()].sort((d,v)=>d[1]-v[1]).map(d=>d[0]));return p}function fe(s,e={}){let t=new Map;function r(y){return t.has(y)||t.set(y,[]),t.get(y)}let n=[],i=new Set,o=0;function a(y){i.has(y)||(i.add(y),n.push(y))}function l(y,m){return y?`${y}.${m}`:m}function c(y,m,b,_){r(y).push({selector:m,prop:b.prop.toLowerCase(),value:Ht(b.value),important:b.important||!1,layer:_})}let u=e.semanticSelectors?Jt:it;function p(y,m,b){let _=y.selectors.map(S=>u(S));for(let S of _)y.each(x=>{x.type==="decl"&&c(m,S,x,b)})}function f(y,m,b){let _=y.name.toLowerCase();if(Yt.has(_)){let S=es(m,_,Kt(y.params)),x=qe(S);y.each(A=>{A.type==="rule"?p(A,x,b):A.type==="atrule"&&f(A,S,b)})}else if(_==="layer"){let S=y.params.trim();if(y.nodes){let x=S?l(b,S):l(b,`__anon${o++}`);a(x);let A=qe(m);y.each(R=>{R.type==="rule"?p(R,A,x):R.type==="atrule"&&f(R,m,x)})}else for(let x of S.split(",")){let A=x.trim();A&&a(l(b,A))}}else if(_==="font-face"){let S="@font-face",x=[];y.each(R=>{R.type==="decl"&&x.push(R)});let A=Po(x);for(let R of x)c(S,A,R,b)}else if(_==="keyframes"||_==="-webkit-keyframes"){let S=Io(_,y.params);y.each(x=>{if(x.type==="rule"){let A=x.selectors.map(R=>R.trim()).join(", ");x.each(R=>{R.type==="decl"&&c(S,A,R,b)})}})}else if(!(_==="charset"||_==="import"||_==="namespace")){if(y.nodes){let S=qe(m);y.each(x=>{x.type==="rule"?p(x,S,b):x.type==="atrule"&&f(x,m,b)})}}}let h=Wt.parse(s,{from:void 0}),d=new Map;h.each(y=>{y.type==="rule"?p(y,"base",null):y.type==="atrule"&&f(y,d,null)});let v=new Map;n.forEach((y,m)=>v.set(y,m));let g=n.length;for(let y of t.values())for(let m of y)m.layerRank=No(m.layer,m.important,v,g),delete m.layer;return t}function he(s){let e=new Map;for(let[t,r]of s){e.has(t)||e.set(t,new Map);let n=e.get(t),i=new Map;for(let{selector:o,prop:a,value:l,important:c,layerRank:u}of r){let p=u??(c?1:0);n.has(o)||(n.set(o,new Map),i.set(o,new Map));let f=n.get(o),h=i.get(o),d=h.get(a);(d===void 0||p>=d)&&(f.set(a,{value:l,important:c}),h.set(a,p))}}return e}function ts(s,e,t={}){let r=new Map,n=new Set([...s.keys(),...e.keys()]),i=["base",...[...n].filter(o=>o!=="base").sort()];for(let o of i){if(!n.has(o))continue;let a=s.get(o)||new Map,l=e.get(o)||new Map,c=new Set([...a.keys(),...l.keys()]),u=new Map,p=0;for(let h of[...c].sort()){let d=a.get(h)||new Map,v=l.get(h)||new Map,g=new Set([...d.keys(),...v.keys()]),y=new Map,m=0;for(let _ of[...g].sort()){let S=d.get(_),x=v.get(_),A;!S&&x?(A={status:"added",newValue:x.value,newImportant:x.important},m++):S&&!x?(A={status:"removed",oldValue:S.value,oldImportant:S.important},m++):(t.ignoreCosmetic?Qt(S.value)!==Qt(x.value):S.value!==x.value)||S.important!==x.important?(A={status:"changed",oldValue:S.value,oldImportant:S.important,newValue:x.value,newImportant:x.important},m++):A={status:"unchanged",value:x.value,important:x.important},y.set(_,A)}let b;a.has(h)?l.has(h)?m>0?b="changed":b="unchanged":b="removed":b="added",u.set(h,{status:b,changeCount:m,props:y}),p+=m}let f;s.has(o)?e.has(o)?p>0?f="changed":f="unchanged":f="removed":f="added",r.set(o,{status:f,changeCount:p,selectors:u})}return r}function Zt([s,e,t],[r,n,i]){return s>r||s===r&&e>n||s===r&&e===n&&t>i}function ns(s,e){return Zt(s,e)?1:Zt(e,s)?-1:0}function ko(s){let e=[],t=0,r=0,n=0,i=null;for(let a=0;a<s.length;a++){let l=s[a];i?l===i&&(i=null):l==='"'||l==="'"?i=l:l==="("?t++:l===")"?t>0&&t--:l==="["?r++:l==="]"?r>0&&r--:l===","&&t===0&&r===0&&(e.push(s.slice(n,a).trim()),n=a+1)}let o=s.slice(n).trim();return o&&e.push(o),e}function qo(s,e){let t=1,r=0,n=e,i=null;for(;n<s.length&&t>0;){let o=s[n];i?o===i&&(i=null):o==='"'||o==="'"?i=o:o==="["?r++:o==="]"?r>0&&r--:r===0&&o==="("?t++:r===0&&o===")"&&t--,n++}return t===0?n:null}function rs(s,e,t){let r=e.global||e.sticky?e:new RegExp(e.source,e.flags+"g");r.lastIndex=0;let n="",i=0,o;for(;(o=r.exec(s))!==null;){let a=o.index+o[0].length,l=qo(s,a);if(n+=s.slice(i,o.index),l===null){n+=s.slice(a),i=s.length;break}t(s,a,l,o),i=l,r.lastIndex=i}return n+s.slice(i)}function pe(s,e=0){if(e>100)return[0,0,0];let t=0,r=0,n=0,i=s.replace(/\\./g,"x"),o=l=>{let c=[0,0,0];for(let u of ko(l)){let p=pe(u,e+1);Zt(p,c)&&(c=p)}t+=c[0],r+=c[1],n+=c[2]};i=rs(i,/:(?<name>nth-child|nth-last-child|not|is|has|matches|where|host-context|host)\s*\(/gi,(l,c,u,p)=>{let f=p.groups.name.toLowerCase(),h=l.slice(c,u-1).trim();if(f==="nth-child"||f==="nth-last-child"){let d=h.match(/\sof\b/i);d&&o(h.slice(d.index+d[0].length).trim()),r++}else f==="where"||(o(h),(f==="host"||f==="host-context")&&r++)}),i=rs(i,/::(?:slotted|cue)\s*\(/gi,(l,c,u)=>{o(l.slice(c,u-1).trim()),n++}),i=i.replace(/::[\w-]+(\([^)]*\))?/g,()=>(n++,"")),i=i.replace(/:(?:before|after|first-line|first-letter)(?![\w-])/gi,()=>(n++,"")),i=i.replace(/\[[^\]]*\]/g,()=>(r++,"")),i=i.replace(/:[^:\s>+~([\].#]+(\([^)]*\))?/g,()=>(r++,"")),i=i.replace(/#[\w-]+/g,()=>(t++,"")),i=i.replace(/\.[\w-]+/g,()=>(r++,"")),i=i.replace(/\|\|/g," ").replace(/[>+~]/g," "),i=i.replace(/(?:[\w-]+|\*)?\|/g,"");let a=i.split(/\s+/).filter(l=>l&&l!=="*"&&/^[a-zA-Z][\w-]*/.test(l));return n+=a.length,[t,r,n]}function ss(s,e){let[t,r,n]=pe(s),[i,o,a]=pe(e);return t===i&&r===o&&n===a}function To(s,e){let t=new Set(s),r=new Set(e),n=s.filter(u=>r.has(u)),i=e.filter(u=>t.has(u)),o=new Map;for(let u=0;u<n.length;u++)o.set(n[u],i[u]);let a=[],l=0,c=new Set;for(let u of s){if(!r.has(u)){a.push({type:"deleted",oldSelector:u,newSelector:null});continue}let p=o.get(u);for(;l<e.length&&!t.has(e[l]);)a.push({type:"added",oldSelector:null,newSelector:e[l]}),l++;if(u===p)a.push({type:"equal",oldSelector:u,newSelector:p});else{let f=[u,p].sort().join("\0");c.has(f)||(c.add(f),a.push({type:"moved",oldSelector:u,newSelector:p}))}l++}for(;l<e.length;)t.has(e[l])||a.push({type:"added",oldSelector:null,newSelector:e[l]}),l++;return a}function er(s,e,t,r,n,i,o){return!t&&!r?null:t?r?t.important!==r.important?t.important?s:e:n!==0?n>0?s:e:i>o?s:e:s:e}function Do(s,e,t,r,n){let i=s.oldSelector,o=s.newSelector;s.sameSpecificity=ss(i,o),s.conflictingProps=[],s.hasOverlappingProps=!1;let a=e.indexOf(i),l=e.indexOf(o),c=t.indexOf(i),u=t.indexOf(o);if(a<0||l<0||c<0||u<0)return;let p=a<l,f=c<u;if(p===f)return;let h=ns(pe(i),pe(o)),d=r.get(i)||new Map,v=r.get(o)||new Map,g=n.get(i)||new Map,y=n.get(o)||new Map;for(let[m,b]of g){let _=y.get(m);if(!_||(s.hasOverlappingProps=!0,b.value===_.value&&b.important===_.important))continue;let S=er(i,o,d.get(m),v.get(m),h,a,l),x=er(i,o,b,_,h,c,u);if(!x)continue;if(!S){let F=er(i,o,b,_,h,a,l);if(!F||F===x)continue;let Y=n.get(F)?.get(m),W=n.get(x)?.get(m);if(!Y||!W||Y.value===W.value&&Y.important===W.important)continue;s.conflictingProps.push({prop:m,oldEffective:null,newEffective:{value:W.value,important:W.important}});continue}let A=r.get(S)?.get(m),R=n.get(x)?.get(m);!A||!R||A.value===R.value&&A.important===R.important||s.conflictingProps.push({prop:m,oldEffective:{value:A.value,important:A.important},newEffective:{value:R.value,important:R.important}})}}function is(s,e,t={}){let r={semanticSelectors:t.semanticSelectors},n=Xt(s,r),i=Xt(e,r),o=he(fe(s,r)),a=he(fe(e,r)),l=new Set([...n.keys(),...i.keys()]),c=["base",...[...l].filter(p=>p!=="base").sort()],u=[];for(let p of c){if(!l.has(p))continue;let f=n.get(p)||[],h=i.get(p)||[],d=To(f,h),v=o.get(p)||new Map,g=a.get(p)||new Map;for(let m of d)m.type==="moved"&&Do(m,f,h,v,g);let y=d.some(m=>m.type==="moved"&&m.hasOverlappingProps);d.some(m=>m.type!=="equal")&&u.push({contextKey:p,rows:d,hasWarning:y})}return u}var us=require("node:fs"),cs=require("node:url");function E(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function os(s,e){let{status:t}=e;function r(n){return n?' <span class="important">!important</span>':""}return t==="added"?`
    ...
    </div>`}function Uo(s,e){let{props:t}=e,r=[],n=[];for(let[o,a]of t){let l=E(o);if(a.status==="unchanged"){let c=E(a.value)+(a.important?" !important":"");r.push(`<div class="detail-line detail-line--unchanged"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${c}</span>;</div>`),n.push(`<div class="detail-line detail-line--unchanged"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${c}</span>;</div>`)}else if(a.status==="added"){r.push('<div class="detail-line detail-line--empty"></div>');let c=E(a.newValue)+(a.newImportant?" !important":"");n.push(`<div class="detail-line detail-line--added"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${c}</span>;</div>`)}else if(a.status==="removed"){let c=E(a.oldValue)+(a.oldImportant?" !important":"");r.push(`<div class="detail-line detail-line--removed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${c}</span>;</div>`),n.push('<div class="detail-line detail-line--empty"></div>')}else{let c=E(a.oldValue)+(a.oldImportant?" !important":""),u=E(a.newValue)+(a.newImportant?" !important":"");r.push(`<div class="detail-line detail-line--changed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${c}</span>;</div>`),n.push(`<div class="detail-line detail-line--changed"><span class="detail-prop">${l}</span><span class="detail-colon">:</span> <span class="detail-val">${u}</span>;</div>`)}}let i=E(s);return`
...
`)}}</code></pre>
    ...
    </tr>`:""}function Wo(s,e=!1){let{contextKey:t,rows:r,hasWarning:n}=s,i=t==="base"?"\u30C8\u30C3\u30D7\u30EC\u30D9\u30EB (base)":E(t),o=r.filter(u=>u.type==="moved").length,a=o===0?'<span class="or-ctx-badge or-ctx-badge--ok">\u9806\u5E8F\u5909\u66F4\u306A\u3057</span>':n?`<span class="or-ctx-badge or-ctx-badge--warning">${o} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4</span>`:`<span class="or-ctx-badge or-ctx-badge--moved">${o} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4\uFF08\u30EA\u30B9\u30AF\u306A\u3057\uFF09</span>`,l=`<span class="or-toggle-icon">${e?"\u25BC":"\u25B6"}</span>`,c=r.map(u=>u.type==="moved"?Go(u):Vo(u)).join("");return`<div class="or-context">
  ...
  </div>`}function ls(s,{activeContext:e="all",filterOrderRisk:t=!1,expandedContexts:r=new Set}={}){if(!s||s.length===0)return"";let n=t?s.filter(c=>c.hasWarning):s,i=e==="all"?n:n.filter(c=>c.contextKey===e);if(i.length===0)return"";let o=i.reduce((c,u)=>c+u.rows.filter(p=>p.type==="moved").length,0);if(o===0)return"";let a=i.some(c=>c.hasWarning),l=i.map(c=>Wo(c,r.has(c.contextKey))).join("");return`<section class="order-risks-section">
    <div class="order-risks-header">
      <span class="order-risks-title">\u30BB\u30EC\u30AF\u30BF\u51FA\u73FE\u9806\u306E\u6BD4\u8F03</span>
      ${a?`<span class="order-risks-count order-risks-count--warning">\u26A0\uFE0F ${o} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4</span>`:`<span class="order-risks-count order-risks-count--ok">${o} \u4EF6\u306E\u9806\u5E8F\u5909\u66F4\uFF08\u30EA\u30B9\u30AF\u306A\u3057\uFF09</span>`}
    </div>
    ${l}
  </section>`}function as(s,e,{activeContext:t="all",showUnchanged:r=!1,expandedSelectors:n=new Set}={}){if(!s||s.size===0)return'<div class="empty-state">CSS \u3092\u8AAD\u307F\u8FBC\u3093\u3067\u304F\u3060\u3055\u3044\u3002</div>';let i=null;if(e!==null){i=new Map;for(let a of e)i.has(a.contextKey)||i.set(a.contextKey,[]),i.get(a.contextKey).push({selector:a.selector,positions:a.positions||new Set})}let o="";for(let[a,l]of s){if(t!=="all"&&a!==t)continue;let c=i?i.get(a)||[]:null;i&&c.length===0||(o+=Fo(a,l,c,{showUnchanged:r,expandedSelectors:n}))}return o||'<div class="empty-state">\u6761\u4EF6\u306B\u4E00\u81F4\u3059\u308B\u30BB\u30EC\u30AF\u30BF\u304C\u3042\u308A\u307E\u305B\u3093\u3002</div>'}var Jo={};function Ko(){return`/* \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
   CSS Diff App \u2014 \u30B9\u30BF\u30A4\u30EB
   \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
...
${e.cyan}[${r}]${e.reset}`),console.log(`  ${"\u65E7 CSS".padEnd(o)}  ${"\u65B0 CSS".padEnd(a)}  \u72B6\u614B`),console.log(`  ${"-".repeat(o)}  ${"-".repeat(a)}  ------`);for(let l of i){let c=(l.oldSelector??"-").padEnd(o),u=(l.newSelector??"-").padEnd(a);if(l.type==="moved"){let p=l.sameSpecificity?` ${e.dim}(\u8A73\u7D30\u5EA6\u304C\u540C\u3058)${e.reset}`:"";if(console.log(`  ${c}  ${u}  ${e.yellow}\u26A0 \u9806\u5E8F\u5909\u66F4${e.reset}${p}`),l.conflictingProps&&l.conflictingProps.length>0)for(let f of l.conflictingProps){let h=g=>g?.important?" !important":"",d=f.oldEffective?`${f.oldEffective.value}${h(f.oldEffective)}`:"\u65E7 CSS \u672A\u5BA3\u8A00",v=f.newEffective?`${f.newEffective.value}${h(f.newEffective)}`:"\u65B0 CSS \u672A\u5BA3\u8A00";console.log(`    ${e.dim}${f.prop}: ${d} \u2192 ${v}${e.reset}`)}}else l.type==="deleted"?console.log(`  ${c}  ${"-".padEnd(a)}  ${e.red}- \u524A\u9664${e.reset}`):l.type==="added"&&console.log(`  ${"-".padEnd(o)}  ${u}  ${e.green}+ \u8FFD\u52A0${e.reset}`)}}}}process.exit(Ss||bs?1:0);
